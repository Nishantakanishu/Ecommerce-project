...
const Carousel = () => {
  ...
  const SamplePrevArrow = (props) => {
    ...
    <AiOutlineArrowLeft className='arrows' style={{...style, display:"block",
     borderRadius:"50px", background:"#f53347" , color:"white", position: "absolute",
      padding:"2px", left:"50px"}} />
    </div>
  )
}
...
return (
    ...
    <AiOutlineArrowRight className='arrows' style={{...style, display:"block" ,
     borderRadius:"50px", background:"#f53347" , color:"white", position: "absolute",
            ...
            return <div key={index} className='bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] -z-10'>
              <div className='flex gap-10 justify-center h-[600px] items-center px-4'>
                <div className='space-y-6'>
                  ...
                  <h1 className='text-3xl font-bold uppercase line-clamp-3 md:w-[500px] text-white'>{item.title}</h1>
